...
|----------|------|--------------|
| [OllamaToolkit.App-v1.1.1-win-x64.zip](OllamaToolkit.App-v1.1.1-win-x64.zip) | ~1 MB | [.NET 8 Desktop Runtime](https://dotnet.microsoft.com/download/dotnet/8.0) |
| [v1.1.1 folder](v1.1.1/OllamaToolkit.App.exe) (unzipped) | ~2 MB | Same — run `OllamaToolkit.App.exe` directly |
...
This refreshes `releases/v1.1.1/` and the zip files in this folder.